          ...
          <div>
            ...
            <div className="space-y-4">
                ...
                <div className="flex items-center gap-4 group">
                  ...
                  <span className="text-navy-900 font-medium tracking-wide">Family Office Liability</span>
                </div>
                ...
                <div className="flex items-center gap-4 group">
                  ...
                  <span className="text-navy-900 font-medium tracking-wide">Kidnap & Ransom Protection</span>
                </div>
                ...
                <div className="flex items-center gap-4 group">
                  ...
                  <span className="text-navy-900 font-medium tracking-wide">High-Limit Umbrella Liability</span>
                </div>
                ...
                <div className="flex items-center gap-4 group">
                  ...
                  <span className="text-navy-900 font-medium tracking-wide">Cyber Defense for Individuals</span>
                </div>
