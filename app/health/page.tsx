    ...
    <main className="min-h-screen bg-[#FDFDFD]">
      ...
      <section className="py-20 container mx-auto px-6">
        <div className="grid md:grid-cols-3 gap-8">
          <div className="bg-white p-8 border border-gray-100 hover:border-gold-500 transition-all">
            ...
            <h2 className="text-2xl font-serif text-navy-900 mb-4">Low-Cost PPO</h2>
          ...
          <div className="bg-navy-900 text-white p-8 shadow-xl transform md:-translate-y-4">
            ...
            <h2 className="text-2xl font-serif mb-4">Affordable Life</h2>
          ...
          <div className="bg-white p-8 border border-gray-100 hover:border-gold-500 transition-all">
            ...
            <h2 className="text-2xl font-serif text-navy-900 mb-4">Business Savings</h2>
      ...
      <section className="py-20 bg-gray-50">
        <div className="container mx-auto px-6">
           <h2 className="text-3xl font-serif text-navy-900 mb-12 text-center">US Premium Cost & Coverage FAQ</h2>
