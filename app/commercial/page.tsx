          ...
          >
            ...
            <div className="grid gap-6">
                ...
                <div className="flex items-start gap-4 p-4 border border-gray-100 hover:border-gold-500/30 hover:shadow-lg transition-all rounded-sm bg-white">
                  ...
                  <div>
                    <h4 className="text-navy-900 font-bold tracking-wide text-sm mb-1">Directors & Officers (D&O)</h4>
                ...
                <div className="flex items-start gap-4 p-4 border border-gray-100 hover:border-gold-500/30 hover:shadow-lg transition-all rounded-sm bg-white">
                  ...
                  <div>
                    <h4 className="text-navy-900 font-bold tracking-wide text-sm mb-1">Professional Indemnity</h4>
                    <p className="text-gray-500 text-xs">Comprehensive protection included.</p>
                  </div>
                </div>
                ...
                <div className="flex items-start gap-4 p-4 border border-gray-100 hover:border-gold-500/30 hover:shadow-lg transition-all rounded-sm bg-white">
                  ...
                  <div>
                    <h4 className="text-navy-900 font-bold tracking-wide text-sm mb-1">Cyber Risk Insurance</h4>
                    <p className="text-gray-500 text-xs">Comprehensive protection included.</p>
                  </div>
                </div>
                ...
                <div className="flex items-start gap-4 p-4 border border-gray-100 hover:border-gold-500/30 hover:shadow-lg transition-all rounded-sm bg-white">
                  ...
                  <div>
                    <h4 className="text-navy-900 font-bold tracking-wide text-sm mb-1">Global Supply Chain Protection</h4>
                    <p className="text-gray-500 text-xs">Comprehensive protection included.</p>
                  </div>
                </div>
