          ...
          <div>
            ...
            <div className="space-y-4">
                ...
                <div className="flex items-center gap-4 group">
                  ...
                  <span className="text-navy-900 font-medium tracking-wide">Directors & Officers (D&O)</span>
                </div>
                ...
                <div className="flex items-center gap-4 group">
                  ...
                  <span className="text-navy-900 font-medium tracking-wide">Professional Indemnity</span>
                </div>
                ...
                <div className="flex items-center gap-4 group">
                  ...
                  <span className="text-navy-900 font-medium tracking-wide">Cyber Risk Insurance</span>
                </div>
                ...
                <div className="flex items-center gap-4 group">
                  ...
                  <span className="text-navy-900 font-medium tracking-wide">Global Supply Chain Protection</span>
                </div>
