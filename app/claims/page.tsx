          ...
          >
            ...
            <div className="grid gap-6">
                ...
                <div className="flex items-start gap-4 p-4 border border-gray-100 hover:border-gold-500/30 hover:shadow-lg transition-all rounded-sm bg-white">
                  ...
                  <div>
                    <h4 className="text-navy-900 font-bold tracking-wide text-sm mb-1">24/7 Dedicated Claims Advocate</h4>
                ...
                <div className="flex items-start gap-4 p-4 border border-gray-100 hover:border-gold-500/30 hover:shadow-lg transition-all rounded-sm bg-white">
                  ...
                  <div>
                    <h4 className="text-navy-900 font-bold tracking-wide text-sm mb-1">Direct Adjuster Access</h4>
                    <p className="text-gray-500 text-xs">Comprehensive protection included.</p>
                  </div>
                </div>
                ...
                <div className="flex items-start gap-4 p-4 border border-gray-100 hover:border-gold-500/30 hover:shadow-lg transition-all rounded-sm bg-white">
                  ...
                  <div>
                    <h4 className="text-navy-900 font-bold tracking-wide text-sm mb-1">Rental & Replacement Concierge</h4>
                    <p className="text-gray-500 text-xs">Comprehensive protection included.</p>
                  </div>
                </div>
                ...
                <div className="flex items-start gap-4 p-4 border border-gray-100 hover:border-gold-500/30 hover:shadow-lg transition-all rounded-sm bg-white">
                  ...
                  <div>
                    <h4 className="text-navy-900 font-bold tracking-wide text-sm mb-1">Rapid Settlement Protocol</h4>
                    <p className="text-gray-500 text-xs">Comprehensive protection included.</p>
                  </div>
                </div>
